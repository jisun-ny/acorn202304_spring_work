...
//component scan을 통해서 bean이 될 수 있도록 섭스  클래스는 @Service 어노테이션을 붙인다.
@Service
public class GuestServiceImpl implements GuestService {
	//서비스는 비지니스 로직을 처리하기 위해 Dao에 의존한다.
	@Autowired
	...
	//메소드의 인자로 전달된 ModelAndView 객체에 글 하나의 정보(주어진 num)를 담는 로직을 처리하는 메소드
	@Override
