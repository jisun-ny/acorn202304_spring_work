...
<body>
	<div class="container">
		...
		<%--로그인된 아이디와 글의 작성자가 같으면 수정, 삭제 링크를 제공함 --%>
            ...
            */
            ...
            .then(function(data){
               ...
               document.querySelector(".comments ul")
                  .insertAdjacentHTML("beforeend", data); //문자열을 통채로 집어넣으면 알아서 li요소가 나온다.
               //로딩이 끝났다고 표시한다.
               isLoading=false;
